...
//        Validate.inclusiveBetween(0L, 9223372036854775807L, durationMillis, "durationMillis must not be negative");
...
//        DurationFormatUtils.Token[] arr$ = tokens;
//        int len$ = tokens.length;
//
//        for(int i$ = 0; i$ < len$; ++i$) {
//            DurationFormatUtils.Token token = arr$[i$];
